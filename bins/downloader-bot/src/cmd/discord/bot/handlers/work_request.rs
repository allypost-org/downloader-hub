...
use crate::{
    cmd::discord::bot::handlers::delivery::start_request_task,
...
/// scan.
pub async fn startup_scan() -> Result<(), anyhow::Error> {
    loop {
...
async fn recover_request(req: &WorkRequest) {
    use crate::cmd::discord::bot::helpers::status_message::StatusMessage;
